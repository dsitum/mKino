...
/**
 * Ova klasa služi za ostvarivanje pristupa lokalnoj bazi podataka. Kada se instancira ovaj objekt, stvaraju se sve potrebne tablice kako bi bile spremne za postupak èitanja/pisanja
 * @author domagoj
 *
 */
public class DbHelper extends SQLiteOpenHelper {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		// ovo mora biti ovdje, unatoè tome što zasad ne treba i što možda neæe trebati
	}
}